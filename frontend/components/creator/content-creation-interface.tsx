...
export default function ContentCreationInterface({ onSave, onCancel, initialData }: ContentCreationInterfaceProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#121212] z-50 flex">
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-4xl">
            <Card className="bg-white border-0 shadow-lg min-h-[600px]">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <Input
                          ...
                          className="border border-[#c5c5c5] focus:border-[#2196f3]"
                          icon={<Eye className="h-4 w-4 text-[#8d8d8d]" />}
                        />
                        <Input
                          ...
                          className="border border-[#c5c5c5] focus:border-[#2196f3]"
                          icon={<Heart className="h-4 w-4 text-[#8d8d8d]" />}
                        />
                        <Input
                          ...
                          className="border border-[#c5c5c5] focus:border-[#2196f3]"
                          icon={<MessageCircle className="h-4 w-4 text-[#8d8d8d]" />}
                        />
                        <Input
      ...
      <div className="w-80 bg-white border-l border-[#c5c5c5] flex flex-col">
        ...
        <div className="mt-auto p-6 space-y-3">
          ...
          <Button variant="ghost" onClick={onCancel} className="w-full text-[#8d8d8d] hover:bg-[#f5f5f5]">
            Cancel
          </Button>
        </div>
      </div>
